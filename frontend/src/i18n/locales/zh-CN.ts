export default {
  ...
  agentEditor: {
    ...
    im: {
      title: "IM 集成",
      description: "将智能体接入即时通讯平台，支持企业微信、飞书、Slack、Telegram、钉钉、Mattermost、微信、微信服务号和 QQBot",
      wecom: "企业微信",
      feishu: "飞书",
      slack: "Slack",
      telegram: "Telegram",
      ...
      wechatMPConsole: "微信公众平台",
      wechatMPModeHint: "微信服务号固定使用 Webhook 接入和完整输出；保存后复制回调地址到公众平台服务器配置。",
      wechatMPHint: "支持测试号或认证服务号。当前仅处理文本消息，回复通过客服消息异步推送。",
      wechatMPTokenHint: "需与微信公众平台「服务器配置」中的 Token 完全一致，用于回调签名校验。",
      wechatMPAPIBaseURLHint: "可选，留空使用 https://api.weixin.qq.com。私有代理地址必须使用 HTTPS，并通过后端 SSRF 校验。",
      wechatMPCredentialsRequired: "请填写微信服务号 App ID、App Secret 和 Token",
