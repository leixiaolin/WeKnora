...
\
  ...
  agentEditor: {
    ...
    im: {
      ...
      description: 'Connect agent to instant messaging platforms like WeCom, Feishu, Slack, Telegram, DingTalk, Mattermost, WeChat, WeChat Official Account and QQBot',
      feishu: 'Feishu',
      slack: 'Slack',
      telegram: 'Telegram',
      dingtalk: 'DingTalk',
      ...
      wechatMPModeHint: 'WeChat Official Account always uses Webhook mode and full responses. After saving, copy the callback URL into the WeChat server configuration.',
      wechatMPHint: 'Supports sandbox test accounts or verified service accounts. This MVP handles text messages only and replies asynchronously via customer-service messages.',
      wechatMPTokenHint: 'Must exactly match the Token configured in WeChat server settings. It is used for callback signature verification.',
      wechatMPAPIBaseURLHint: 'Optional. Leave empty to use https://api.weixin.qq.com. Private proxy URLs must use HTTPS and pass backend SSRF checks.',
      wechatMPCredentialsRequired: 'Enter WeChat Official Account App ID, App Secret, and Token',
